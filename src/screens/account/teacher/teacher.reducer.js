import {
    ...
    TEACHER_GET_MYSELF_DATA, TEACHER_GET_MYSELF_DATA_SUCCESS, TEACHER_GET_MYSELF_DATA_ERROR
...
const teacherReducer = (state = initialState, action) => {
    switch (action.type) {
        /* profile and other */
        case TEACHER_GET_MYSELF_DATA: return { ...state, getMyselfDataStatus: REQUEST_STATUS.LOADING };
        case TEACHER_GET_MYSELF_DATA_SUCCESS: return { ...state, getMyselfDataStatus: REQUEST_STATUS.SUCCESS, myData: action.response };
        case TEACHER_GET_MYSELF_DATA_ERROR: return { ...state, getMyselfDataStatus: REQUEST_STATUS.ERROR };
