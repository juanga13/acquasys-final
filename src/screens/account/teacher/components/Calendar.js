...
import { ModalEdit } from '../../../common/components/Modals';
...
const mapDispatchToProps = (dispatch) => ({
    // admin.lessons things
    changeModalState: (modalState) => dispatch(teacherActions.adminLessonsChangeModalState(modalState)),
    inputChange: (id, value) => dispatch(teacherActions.adminLessonsInputChange(id, value)),
    selectLesson: (lesson) => dispatch(teacherActions.selectLesson(lesson)),
